        ...
        <div class="container-fluid">
          ...
          <form action="<?php echo $action; ?>" method="post" class="mb-2">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="byrspp" id="byrspp" placeholder="SPP" value="<?php echo $byrspp; ?>" />
            </div>
            <div class="form-group">
                <label for="int">Catering <?php echo form_error('byrcatering') ?></label>
                <input type="text" class="form-control" name="byrcatering" id="byrcatering" placeholder="Catering" value="<?php echo $byrcatering; ?>" />
            </div>
            <div class="form-group">
