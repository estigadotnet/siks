    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col">
              <form method="post" action="<?php echo site_url('t102_pengeluaran/laporan'); ?>" class="form-horizontal">
          ...
          <?php } else { ?>
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="4">
              ...
              <?php
                ...
                foreach($t102_pengeluaran_data as $d) {
                  echo "<tr>
            ...
            <a href="<?php echo site_url(); ?>t102_pengeluaran/laporan_xls?tglBayar=<?php echo $q; ?>" class="no-print" target="_blank">Export to Excel</a>
            </div>
          <?php } ?>
        </div>
        <!-- /.container-fluid -->
