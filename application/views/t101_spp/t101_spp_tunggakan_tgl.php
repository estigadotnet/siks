    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col">
              <form method="post" action="<?php echo site_url('t101_spp/tunggakan_tgl'); ?>" class="form-horizontal">
          ...
          <?php } else { ?>
            ...
            <a href="<?php echo site_url(); ?>t101_spp/tunggakan_tgl_xls?tglBayar=<?php echo $q; ?>" class="no-print" target="_blank">Export to Excel</a>
            </div>
          <?php } ?>
        </div>
        <!-- /.container-fluid -->
