	...
	public function login()
	{
		...
		if ($this->form_validation->run() === TRUE)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				$this->session->set_userdata("tahunajaran", $this->input->post("tahunajaran"));

				// ambil nama sekolah dan kode sekolah
				$this->load->model("T000_sekolah_model");
				$dataSekolah = $this->T000_sekolah_model->get_all();
				$this->session->set_userdata("kodesekolah", $dataSekolah[0]->kode);
				$this->session->set_userdata("namasekolah", $dataSekolah[0]->nama);
				redirect('/', 'refresh');
			}
			else
			{
		...
		else
		{
			...
			$query = $this->t001_tahunajaran_model->query_get_all();
